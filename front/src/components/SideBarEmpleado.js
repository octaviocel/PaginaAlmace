...
export default function SideBarDashEmpleado({rol}) {
    ...
    return (
        ...
        <div className="pcoded-main-container" id="contenedorLarge" style={{ marginTop: "73px" }}>
            <div className="pcoded-wrapper">
                ...
                <nav className="pcoded-navbar" navbar-theme="theme1" active-item-theme="theme1" id="navegador" sub-item-theme="theme2" active-item-style="style0" pcoded-navbar-position="fixed">
